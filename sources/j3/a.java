...
public final class a {
    ...
    public static a a(int i10) {
        ...
        float[] fArr9 = pVar.f8771g;
        float f15 = pVar.f8773i;
        float f16 = pVar.f8768d;
        float f17 = pVar.f8765a;
        float f18 = fArr9[0] * f12;
        float f19 = fArr9[1] * f13;
        float f20 = fArr9[2] * f14;
        float f21 = pVar.f8772h;
        ...
        float fPow4 = ((float) Math.pow((f26 * pVar.f8766b) / f17, pVar.j * f16)) * 100.0f;
        Math.sqrt(fPow4 / 100.0f);
        float f28 = f17 + 4.0f;
        float fPow5 = ((float) Math.pow(1.64d - Math.pow(0.29d, pVar.f8770f), 0.73d)) * ((float) Math.pow((((((((float) (Math.cos(((((double) (((double) fAtan2) < 20.14d ? 360.0f + fAtan2 : fAtan2)) * 3.141592653589793d) / 180.0d) + 2.0d) + 3.8d)) * 0.25f) * 3846.1538f) * pVar.f8769e) * pVar.f8767c) * ((float) Math.sqrt((f23 * f23) + (f22 * f22)))) / (f25 + 0.305f), 0.9d)) * ((float) Math.sqrt(((double) fPow4) / 100.0d));
    ...
    public static a b(float f9, float f10, float f11) {
        p pVar = p.f8764k;
        float f12 = pVar.f8768d;
        Math.sqrt(((double) f9) / 100.0d);
        float f13 = pVar.f8765a + 4.0f;
        float f14 = pVar.f8773i * f10;
        Math.sqrt(((f10 / ((float) Math.sqrt(r1))) * pVar.f8768d) / f13);

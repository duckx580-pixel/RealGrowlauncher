...
public final class b extends CharsetEncoder {
    ...
    public b(c cVar) {
        ...
        e eVar = new e();
        eVar.f8434a = CoderResult.UNDERFLOW;
        this.f8431a = eVar;
    }
    ...
    public final CoderResult encodeLoop(CharBuffer charBuffer, ByteBuffer byteBuffer) {
            ...
            while (true) {
                try {
                    ...
                    if (c10 <= 255) {
                        ...
                        iPosition++;
                    } else if (this.f8431a.a(c10, charBuffer) < 0) {
                        coderResultUnmappableForLength = this.f8431a.f8434a;
                    } else {
                        if (!this.f8431a.f8435b) {
                            i10 = 1;
                        }
        ...
        try {
            ...
            } else if (this.f8431a.b(cArrArray[i13], cArrArray, i13, iLimit) < 0) {
                coderResultUnmappableForLength2 = this.f8431a.f8434a;
            } else {
                if (!this.f8431a.f8435b) {
                    i10 = 1;
                }

...
public final class p extends a implements Serializable {
    ...
    public static final p f8488l;
    private static final long serialVersionUID = 3127340209035924785L;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public volatile transient boolean f8489c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public transient int[] f8490d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public transient int f8491e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public transient int f8492f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public transient int f8493g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public transient int f8494h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public transient int f8495i;
    ...
    public final b v(int i10, int i11) {
        ...
        if (i11 > rVar.f8498a.c0(rVar.f8499b, 12)) {
    ...
    public final void X() {
        ...
        try {
            ...
            int[] iArrY = Y(iK, map);
            this.f8490d = iArrY;
            this.f8492f = iArrY[3612];
            for (int i11 = 1300; i11 < 1600; i11++) {
                int iC0 = c0(i11, 12);
                this.j = Math.min(this.j, iC0);
                this.f8496k = Math.max(this.f8496k, iC0);
            }
            this.f8489c = true;
        } catch (Exception e8) {
    ...
    public final j$.time.temporal.v y(j$.time.temporal.a aVar) {
        X();
        if (aVar != null) {
            switch (o.f8487a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.v.g(this.f8494h, this.f8495i);
                case 2:
                    return j$.time.temporal.v.f(1L, this.f8496k);
                case 3:
                    return j$.time.temporal.v.f(1L, 5L);
                case 4:
                case 5:
                    int i10 = this.f8493g;
                    return j$.time.temporal.v.f(i10 / 12, (((this.f8490d.length - 1) + i10) / 12) - 1);
                case 6:
    ...
    public final long Z(int i10, int i11, int i12) {
        ...
        int i13 = (i11 - 1) + ((i10 * 12) - this.f8493g);
        if (i13 < 0 || i13 >= this.f8490d.length) {
        ...
        return (i12 - 1) + this.f8490d[i13];
    }

    public final int a0(int i10, int i11) {
        int i12 = (i11 - 1) + ((i10 * 12) - this.f8493g);
        if (i12 >= 0) {
    ...
    public final int[] Y(int i10, Map map) {
        ...
        for (int i12 = 1300; i12 <= 1600; i12++) {
            ...
            while (i13 < 12) {
                ...
                i10 += i14;
                this.f8494h = Math.min(this.f8494h, i14);
                this.f8495i = Math.max(this.f8495i, i14);
                i13++;
                i11 = i15;
            }
        }

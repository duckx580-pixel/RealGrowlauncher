...
public abstract class b {
    ...
    public static final void a(c cVar, g0 g0Var) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            if (i0Var instanceof k0) {
                h hVar = new h();
                k0 k0Var = (k0) i0Var;
                hVar.f9050d = k0Var.f9086r;
                hVar.f9059n = true;
                hVar.c();
                hVar.f9064s.f6883a.setFillType(k0Var.f9087s == 1 ? Path.FillType.EVEN_ODD : Path.FillType.WINDING);
                hVar.c();
                hVar.c();
                hVar.f9048b = k0Var.f9088t;
                hVar.c();
                hVar.f9049c = k0Var.f9089u;
                hVar.c();
                hVar.f9053g = k0Var.f9090v;
                hVar.c();
                hVar.f9051e = k0Var.w;
                hVar.c();
                hVar.f9052f = k0Var.f9091x;
                hVar.f9060o = true;
                hVar.c();
                hVar.f9054h = k0Var.f9092y;
                hVar.f9060o = true;
                hVar.c();
                hVar.f9055i = k0Var.f9093z;
                hVar.f9060o = true;
                hVar.c();
                hVar.j = k0Var.A;
                hVar.f9060o = true;
                ...
                c cVar2 = new c();
                g0 g0Var2 = (g0) i0Var;
                cVar2.f8981k = g0Var2.f9039i;
                cVar2.c();
                cVar2.f8982l = g0Var2.f9040r;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8985o = g0Var2.f9043u;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8986p = g0Var2.f9044v;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8987q = g0Var2.w;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8988r = g0Var2.f9045x;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8983m = g0Var2.f9041s;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8984n = g0Var2.f9042t;
                cVar2.f8989s = true;
                cVar2.c();
                cVar2.f8977f = g0Var2.f9046y;
                cVar2.f8978g = true;
                cVar2.c();
                a(cVar2, g0Var2);
                cVar.e(i10, cVar2);
    ...
    public static final j0 c(f fVar, o0.o oVar) {
        ...
        if (zF || objL == o0.k.f12455a) {
            c cVar = new c();
            a(cVar, fVar.f9030f);
            long jH = a.a.h(bVar.W(fVar.f9026b), bVar.W(fVar.f9027c));
            float fD = fVar.f9028d;
            float fB = fVar.f9029e;
            if (Float.isNaN(fD)) {
                fD = f1.f.d(jH);
            }
            if (Float.isNaN(fB)) {
            ...
            boolean z3 = fVar.f9033i;
            j0Var.f9075v.setValue(new f1.f(jH));
            j0Var.w.setValue(Boolean.valueOf(z3));
            e0 e0Var = j0Var.f9076x;
            e0Var.f9017g.setValue(lVar);
            e0Var.f9019i.setValue(new f1.f(jH2));
            e0Var.f9013c = str;
            oVar.g0(j0Var);
            objL = j0Var;
        }
    ...
    public static final void d(List list, g1.e0 e0Var) {
        ...
        b0 b0Var3 = list2.isEmpty() ? j.f9074c : (b0) list2.get(0);
        int size = list2.size();
        float f24 = 0.0f;
        int i12 = 0;
        float f25 = 0.0f;
        ...
        while (i12 < size) {
            ...
            if (b0Var4 instanceof j) {
                ...
                v vVar = (v) b0Var4;
                float f31 = vVar.f9125c;
                f30 += f31;
                float f32 = vVar.f9126d;
                f25 += f32;
                ...
                n nVar = (n) b0Var4;
                float f33 = nVar.f9097c;
                float f34 = nVar.f9098d;
                ...
                if (b0Var4 instanceof u) {
                    u uVar = (u) b0Var4;
                    float f35 = uVar.f9124d;
                    float f36 = uVar.f9123c;
                    ...
                    if (b0Var4 instanceof m) {
                        ...
                        float f38 = ((z) b0Var4).f9137c;
                        path3.rLineTo(f24, f38);
                        f25 += f38;
                    } else if (b0Var4 instanceof a0) {
                        float f39 = ((a0) b0Var4).f8968c;
                        ...
                        if (b0Var4 instanceof s) {
                            ...
                            f9 = f25;
                            b0Var = b0Var4;
                            path3.rCubicTo(sVar.f9116c, sVar.f9117d, sVar.f9118e, sVar.f9119f, sVar.f9120g, sVar.f9121h);
                            f16 = sVar.f9118e + f30;
                            f21 = sVar.f9119f + f9;
                            f30 += sVar.f9120g;
                            f22 = sVar.f9121h;
                            ...
                            if (b0Var instanceof k) {
                                k kVar = (k) b0Var;
                                path3.cubicTo(kVar.f9079c, kVar.f9080d, kVar.f9081e, kVar.f9082f, kVar.f9083g, kVar.f9084h);
                                f16 = kVar.f9081e;
                                f17 = kVar.f9082f;
                                f18 = kVar.f9083g;
                                f12 = kVar.f9084h;
                                ...
                                x xVar = (x) b0Var;
                                path3.rCubicTo(f19, f20, xVar.f9131c, xVar.f9132d, xVar.f9133e, xVar.f9134f);
                                f16 = xVar.f9131c + f30;
                                f21 = xVar.f9132d + f9;
                                f30 += xVar.f9133e;
                                f22 = xVar.f9134f;
                                ...
                                p pVar = (p) b0Var;
                                path3.cubicTo(f30, f15, pVar.f9103c, pVar.f9104d, pVar.f9105e, pVar.f9106f);
                                f16 = pVar.f9103c;
                                f17 = pVar.f9104d;
                                f18 = pVar.f9105e;
                                f12 = pVar.f9106f;
                                ...
                                w wVar = (w) b0Var;
                                float f42 = wVar.f9130f;
                                float f43 = wVar.f9129e;
                                float f44 = wVar.f9128d;
                                float f45 = wVar.f9127c;
                                ...
                                if (b0Var instanceof o) {
                                    o oVar = (o) b0Var;
                                    f12 = oVar.f9102f;
                                    float f47 = oVar.f9101e;
                                    float f48 = oVar.f9100d;
                                    float f49 = oVar.f9099c;
                                    ...
                                    y yVar = (y) b0Var;
                                    float f50 = yVar.f9136d;
                                    float f51 = yVar.f9135c;
                                    ...
                                    r rVar = (r) b0Var;
                                    float f56 = rVar.f9114h + f30;
                                    float f57 = rVar.f9115i + f9;
                                    f10 = 0.0f;
                                    path = path3;
                                    i11 = i12;
                                    i10 = size;
                                    iVar = iVar;
                                    b(iVar, f30, f9, f56, f57, rVar.f9109c, rVar.f9110d, rVar.f9111e, rVar.f9112f, rVar.f9113g);
                                    f28 = f28;
                                    f29 = f29;
                                    f26 = f56;
                                    f30 = f26;
                                    ...
                                    if (b0Var instanceof i) {
                                        i iVar2 = (i) b0Var;
                                        float f60 = iVar2.f9073i;
                                        float f61 = iVar2.f9072h;
                                        b0Var2 = b0Var;
                                        iVar = iVar;
                                        b(iVar, f30, f9, f61, f60, iVar2.f9067c, iVar2.f9068d, iVar2.f9069e, iVar2.f9070f, iVar2.f9071g);
                                        f25 = f60;
                                        f27 = f25;
                                        f28 = f58;
                                        f29 = f59;

...
public final class AccessibleForwardKt {
    ...
    public static final f getAccessibleForward(b bVar) {
        l.f("<this>", bVar);
        f fVar = _accessibleForward;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.AccessibleForward", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        gb.e.o(nVarB, 18.0f, 16.0f, 5.0f, 2.0f);
        nVarB.t(-5.5f);

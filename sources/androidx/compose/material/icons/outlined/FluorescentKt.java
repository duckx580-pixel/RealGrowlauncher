...
public final class FluorescentKt {
    ...
    public static final f getFluorescent(b bVar) {
        l.f("<this>", bVar);
        f fVar = _fluorescent;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Fluorescent", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList2.add(new k1.n(17.286f, 6.399f));
        arrayList2.add(new u(1.79f, -1.802f));
        d.c(1.419f, 1.409f, -1.79f, 1.802f, arrayList2);
        arrayList2.add(jVar);
        ...
        arrayList5.add(new k1.n(3.495f, 6.009f));
        arrayList5.add(new u(1.407f, -1.407f));
        d.c(1.789f, 1.789f, -1.407f, 1.407f, arrayList5);
        arrayList5.add(jVar);
        e.a(eVar, arrayList5, 0, m0Var6);
        m0 m0Var7 = new m0(j);
        ArrayList arrayList6 = new ArrayList(32);
        arrayList6.add(new k1.n(3.492f, 18.076f));
        arrayList6.add(new u(1.802f, -1.79f));
        d.c(1.409f, 1.419f, -1.802f, 1.79f, arrayList6);
        arrayList6.add(jVar);

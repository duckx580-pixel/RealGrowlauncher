...
public final class CottageKt {
    ...
    public static final f getCottage(b bVar) {
        l.f("<this>", bVar);
        f fVar = _cottage;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Cottage", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        ...
        nVarS.l(1.0f, 11.4f);
        nVarS.m(1.21f, 1.59f);
        gb.e.n(nVarS, 4.0f, 11.62f, 21.0f, 16.0f);
        nVarS.t(-9.38f);
        nVarS.m(1.79f, 1.36f);
        c.p(nVarS, 23.0f, 11.4f, 12.0f, 3.0f);
        a.p(nVarS, 18.0f, 19.0f, -5.0f, -4.0f);
        a.r(nVarS, -2.0f, 4.0f, 6.0f, -8.9f);
        nVarS.m(6.0f, -4.58f);
        d.v(nVarS, 6.0f, 4.58f, 19.0f);
        nVarS.n(10.0f, 1.0f);

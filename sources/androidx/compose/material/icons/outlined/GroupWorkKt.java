...
public final class GroupWorkKt {
    ...
    public static final f getGroupWork(b bVar) {
        l.f("<this>", bVar);
        f fVar = _groupWork;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.GroupWork", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList.add(new k1.n(8.0f, 14.0f));
        ...
        arrayList2.add(new k1.n(12.0f, 8.0f));
        ...
        arrayList3.add(new k1.n(16.0f, 14.0f));

...
public final class GppBadKt {
    ...
    public static final f getGppBad(b bVar) {
        l.f("<this>", bVar);
        f fVar = _gppBad;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.GppBad", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        ...
        nVarE.m(2.09f, 2.08f);
        nVarE.m(1.41f, -1.41f);
        nVarE.l(13.42f, 12.0f);
        nVarE.m(2.08f, -2.09f);
        nVarE.l(14.09f, 8.5f);
        c.p(nVarE, 12.0f, 10.59f, 9.91f, 8.5f);

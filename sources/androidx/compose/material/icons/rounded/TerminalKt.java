...
public final class TerminalKt {
    ...
    public static final f getTerminal(c cVar) {
        l.f("<this>", cVar);
        f fVar = _terminal;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Terminal", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        ...
        gb.e.r(nVarS, 16.0f, 18.0f, 12.0f, 16.0f);
        nVarS.i(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        nVarS.k(4.0f);
        nVarS.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        nVarS.i(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        nVarS.k(-4.0f);
        nVarS.h(12.45f, 17.0f, 12.0f, 16.55f, 12.0f, 16.0f);
        nVarS.g();
        nVarS.n(6.79f, 9.71f);
        ...
        nVarS.l(8.67f, 13.0f);
        nVarS.m(-1.88f, -1.88f);
        nVarS.h(6.4f, 10.73f, 6.4f, 10.1f, 6.79f, 9.71f);
        nVarS.g();

...
public final class PersonAddKt {
    ...
    public static final f getPersonAdd(c cVar) {
        l.f("<this>", cVar);
        f fVar = _personAdd;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.PersonAdd", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9066a;
        ...
        nVarA.q(1.79f, 4.0f, 4.0f, 4.0f);
        a.n(nVarA, 6.0f, 10.0f, 6.0f, 8.0f);
        ...
        nVarA.i(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        nVarA.q(-0.45f, -1.0f, -1.0f, -1.0f);
        b.D(nVarA, 6.0f, 10.0f, 15.0f, 14.0f);
